...
public class SignIn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uname = (EditText) findViewById(R.id.unEditText);
    ...
    public void loginOnClick(View v){
        ...
        (mAuth.signInWithEmailAndPassword(uname.getText().toString(), pwd.getText().toString()))
    ...
    public void forgetpwd(View v){
        Intent i = new Intent(SignIn.this, ForgetPasswordActivity.class);
        startActivity(i);
    }
