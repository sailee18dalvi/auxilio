...
public class QuestionPaper extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (firebaseAuth.getCurrentUser() == null) {
                    ...
                    startActivity(new Intent(QuestionPaper.this, SignIn.class));
                } else {
                    // User is signed out
